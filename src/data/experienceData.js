export const experiences = [
  {
    ...
    description:
      "Actively building full-stack pet projects to apply and expand skills across the entire stack. Developed a personal CV/portfolio site (belevtsov.dev) with a Node.js/Express backend, Telegram bot integration, Brevo SMTP email notifications, rate limiting, and Zod validation. Contributed to team projects including Money Guard and Gadget House.",
    modalDescription: {
      intro: "Independently designing and shipping full-stack projects to gain real-world experience beyond coursework. All projects are version-controlled on GitHub with consistent commit history and branch workflows.",
      items: [
        ...
        "Phonebook App — Full auth flow with JWT, protected routes, Redux Toolkit, and full contacts CRUD.",
      ],
    },
  },
  {
